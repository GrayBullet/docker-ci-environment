...
RUN ${ANDROID_HOME}/androidsdk_wrapper.sh update sdk --no-ui --no-https --all --filter build-tools-25.0.0,build-tools-24.0.3,build-tools-23.0.3,build-tools-22.0.1,build-tools-21.1.2
